...
const qna = [ // 원하는 줄넘김 부분에 '\n'추가 해주십쇼
    ...
    {
      Question : "회비는 얼마인가요?",
      Answer : "영과일은 회비 없이 운영되고 있으며, 일부 오프라인 행사 또는 대회 참여 시 필요에 따라 소액의 비용이 발생할 수 있습니다.'\n'이 경우 사전에 충분히 공지해드립니다.()"
    },
  ];
...
export default function QnAPage() {
  ...
  return (
    <div className="relative isolate min-h-screen flex h-full w-full flex-col px-40 overflow-hidden">
