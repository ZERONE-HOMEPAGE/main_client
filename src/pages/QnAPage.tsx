...
export default function QnAPage() {
  const qna = [
    ...
    },
    {
      ...
      Answer : "정규 스터디는 주 1~2회 진행되며, 시간은 팀별로 조율하여 결정합니다. 오프라인/온라인 병행 운영으로 일정이 바쁜 경우에도 무리 없이 참여할 수 있습니다.()"
    },
    {
      Question : "회비는 얼마인가요?",
      Answer : "영과일은 회비 없이 운영되고 있으며, 일부 오프라인 행사 또는 대회 참여 시 필요에 따라 소액의 비용이 발생할 수 있습니다. 이 경우 사전에 충분히 공지해드립니다.()"
    },
  ];
