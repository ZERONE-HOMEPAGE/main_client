...
const qna = [
    ...
    },  
    {
      ...
      Answer : "영과일에서는 학습 수준에 따라 C기초반, 브릿지반, 알고리즘반 등 다양한 단계의 스터디를 운영하고 있습니다.\n각 스터디는 경험 많은 멘토들이 직접 지도하며, 자신의 실력에 맞게 배우고 성장할 수 있는 환경을 제공합니다."
    },
    {
      Question : "회비는 얼마인가요?",
    ...
    },
    {
      ...
      Answer : "정규 스터디는 주 1~2회 진행되며, 시간은 팀별로 조율하여 결정합니다.\n오프라인/온라인 병행 운영으로 일정이 바쁜 경우에도 무리 없이 참여할 수 있습니다."
    },
    {
      Question : "주요 행사는 어떤게 있나요?",
      Answer : "모여서 같이 코딩하는 모각코, C 기초 / 자료구조 / 알고리즘 / 코드포스반 등 난이도별 스터디, ZOAC·HEPC 같은 코딩 경시대회 참여,솔브닥 마라톤 주간 인증하면 선물 주는 챌린지, 그리고 실무 선배를 직접 만날 수 있는 네트워킹 데이 같은 행사들이 있습니다."
    },
  ];
  ...
  return (
    <div className="relative isolate min-h-screen flex h-full w-full flex-col">
      ...
      <div className="block w-full md:hidden">
        <div className="flex flex-col mx-10 items-center justify-evenly">
          <div className="mt-20">
            <QnAIntro 
              className_F="text-6xl"
              className_Q="text-7xl"
              className_t="text-base"
            />
          </div>
          <div className="flex flex-col w-full px-10 mb-40">
            {qna.map((QA, key) => (
              <QnABox 
      ...
      <div className="hidden w-full md:block">
        <div className="relative z-10 flex w-full justify-between items-center mt-10 mb-20 px-24">
