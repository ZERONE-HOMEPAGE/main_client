...
export default function ClubIntro() {
  const C_Text = {
    ...
    purposeText:
      '영과일은 알고리즘 문제 해결을 통해 학문적 깊이를 더하고 실제 대회에서의 성과를 통해 현장 경험을 축적하는 것을\n목표로 설립되었습니다. 학회원들은 기초부터 고급 수준까지의 다양한 알고리즘 문제를 풀며 실력을 향상시키고 교내외 대회에서 우수한 성적을 거두는 것을 목표로 하고 있습니다. 학회 활동을 통해 프로그래밍 실력뿐만 아니라 팀워크와 협력의 중요성도 배울 수 있습니다.',
  };
  ...
  const M_Text = {
    ...
    purposeText:
      '영과일은 알고리즘 문제 해결을 통해 학술적 깊이를 더하고 실제 대회에서의 성과를 통해 현장 경험을 축적하는 것을\n목표로 설립되었습니다. 학회원들은 기초부터 고급 수준까지의 다양한 알고리즘 문제를 풀며 실력을 향상시키고 교내외 대회에서 우수한 성적을 거두는 것을 목표로 하고 있습니다. ',
  };
      ...
      <div className="w-full max-w-5xl px-4">
        ...
        <ShadowBox className="w-full">
          <div className="p-6 md:p-8 lg:p-10">
            ...
            <p className="hidden w-full max-w-5xl whitespace-pre-wrap text-lg font-semibold leading-relaxed text-gray-200 md:block md:text-xl">
              {C_Text.purposeText}
            </p>
            <p className="block w-full whitespace-pre-wrap text-lg font-semibold leading-relaxed text-gray-200 md:hidden md:text-xl">
              {M_Text.purposeText}
            </p>
          </div>
        </ShadowBox>
